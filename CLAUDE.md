...
版本状态（2026-09-08）：当前正式基线为 v1.6.0，48 个文件 / 358 项回归通过，包含 Blender 球房和台内精修；妙搭发布 7683015635928927432 完成，正式入口桌面/手机 18 项检查通过。当前版本与发布事实以 PROJECT_BASELINE.md 为准，下文及历史验收中的“未发布”只表示记录当时的状态。
