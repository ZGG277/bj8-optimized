...
独立 Vite + React + Three.js 中式八球实验场（产品名「瓜瓜台球」），验证 240 Hz 物理、连续环绕视角、杆法、规则轮转与真实交互；共享袋口几何采用角袋 92mm/中袋 94mm，视觉按真实球台校准为窄幅浅驼皮圈、细缝边、白色菱形网与后置暗腔，HUD 提供三杆动态实力、默认关闭的预测辅助线、视角控件内手动相机入口、静置半透明/按住实色的无框可停靠五控件及三套主题表达。
