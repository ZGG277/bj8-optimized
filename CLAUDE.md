...
版本状态（2026-09-09）：当前发布候选为 v1.7.0，54 个文件 / 392 项回归通过，包含五种正式世界、新手 25 级起步与 50 级以内禁主动防守、击球后 1.4 秒慢回全台；上一正式基线 v1.6.0 的妙搭发布事实以 PROJECT_BASELINE.md 为准，v1.7.0 只有在取得发布回执并从真实入口验收后才算已发布。
