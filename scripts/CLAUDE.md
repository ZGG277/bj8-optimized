...
`verify-spectator-camera.mjs`: 390×844 对手观战/玩家全局相机门禁（11 断言）：轻提示不拦截触控、回正按钮避让右侧控制轨、默认全台、横滑只改视觉方位、一键回正、顾燃交棒后保持高度/方位、自由相机下准确选择幽灵球、用户拉回第一人称才重新跟杆向、手机瞄准操作时锁镜并在停止后跟杆、玩家主动升到全局视角后吊灯退场且点台面只改瞄准不转整桌，以及全流程无错误。
