...
`useAimInteraction.ts`: 交互协调层，封装开球实体母球按住拖放、自由球虚影落位、合法区域约束、点哪打哪、抓影子球、360° 粗瞄与默认左右微调；屏幕反算显式消费当前视觉相机方位。拨轮不再由落位或拖动自动呼出，只在灯泡开关开启且可瞄准时可见；关闭后退出精瞄档，左右键与拨轮共同修改唯一世界杆向。
