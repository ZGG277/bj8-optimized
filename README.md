...
六个袋口在共享物理/视觉几何中统一放宽到角袋 92mm、中袋 94mm；角袋深色软皮口以精确角衬锚点跨接并把端头藏入库边，消除斜视角下的细小断缝。球桌上的主要控件静置时统一以 56% 内容透明度退后，按住、键盘聚焦或拖动时恢复实色，并取消僵硬的独立卡片外框而保留原触控热区。
...
| `scripts/verify-pockets.mjs` | 共享袋口几何、角袋软皮口 jaw 无缝衔接的桌面俯视、角袋近景、中袋近景与 390×844 竖屏四帧回归 |
