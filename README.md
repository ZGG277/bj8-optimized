...
> 当前正式项目基线：`v1.7.4`（2026-09-10），安静湖面升级为可见浅沙床、稀疏石块、透明 Fresnel 水层与柔和焦散；v1.7.3 的局后留言、28° 镜头和湖面控制简化保持不变。Git 与妙搭发布、桌面及 390×844 正式入口验收均已完成。发布证据见 [PROJECT_BASELINE.md](PROJECT_BASELINE.md)。
